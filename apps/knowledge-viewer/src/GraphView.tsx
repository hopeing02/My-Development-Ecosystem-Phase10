  ...
  useEffect(() => {
    ...
    const instance = cytoscape({
      ...
      style: [
        ...
        { selector: "node[orphan = true]", style: { "background-color": "#97a1b7" } },
        { selector: 'node[sourceId = "ks-002"]', style: { "background-color": "#9b59b6" } },
        { selector: "node[highlighted = true]", style: { "border-width": 5, "border-color": "#ffb020" } },
        { selector: "node[selected = true]", style: { "border-width": 5, "border-color": "#173b8f" } },
        { selector: "node[broken = true]", style: { shape: "round-rectangle", "background-color": "#fff0f0", "border-width": 2, "border-style": "dashed", "border-color": "#c14545", color: "#8d1c1c" } },
        { selector: "edge", style: { width: 1.5, "line-color": "#9aa7c7", "target-arrow-color": "#9aa7c7", "target-arrow-shape": "triangle", "curve-style": "bezier" } },
        { selector: "edge[highlighted = true]", style: { width: 4, "line-color": "#ff8a00", "target-arrow-color": "#ff8a00" } },
        { selector: "edge[broken = true]", style: { "line-style": "dashed", "line-color": "#c14545", "target-arrow-color": "#c14545" } },
      ],
