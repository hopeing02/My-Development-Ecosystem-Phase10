...
public final class ShareActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String targetFolder = getSharedPreferences(MainActivity.PREFERENCES, MODE_PRIVATE)
                .getString(MainActivity.VAULT_FOLDER, SharePayload.DEFAULT_VAULT_FOLDER);
